...
# Generated on: Thu Jul 09 18:26:57 KST 2026 (Thu Jul 09 09:26:57 UTC 2026)
...
set logfile fv/traffic_light/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/traffic_light -revised fv_map
...
add_search_path /home/hah006/Basic_SoC_implementation/1_RTL/2_TINY_PROJECT/2_TRAFFIC_LIGHT -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah006/Basic_SoC_implementation/1_RTL/2_TINY_PROJECT/2_TRAFFIC_LIGHT/traffic_light.v
elaborate_design -golden -root {traffic_light} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/traffic_light/fv_map.v.gz
elaborate_design -revised -root {traffic_light}
...
#add_name_alias fv/traffic_light/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.traffic_light.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.traffic_light.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.traffic_light.rtl.fv_map.rpt

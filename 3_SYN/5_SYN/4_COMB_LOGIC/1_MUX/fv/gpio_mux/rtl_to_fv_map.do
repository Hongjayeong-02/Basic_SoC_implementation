...
# Generated on: Thu Jul 09 00:33:45 KST 2026 (Wed Jul 08 15:33:45 UTC 2026)
...
set logfile fv/gpio_mux/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/gpio_mux -revised fv_map
...
add_search_path /home/hah006/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/1_MUX -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah006/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/1_MUX/gpio_mux.v
elaborate_design -golden -root {gpio_mux} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/gpio_mux/fv_map.v.gz
elaborate_design -revised -root {gpio_mux}
...
set_system_mode lec
write_compared_points noneq.compared_points.gpio_mux.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.gpio_mux.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.gpio_mux.rtl.fv_map.rpt
